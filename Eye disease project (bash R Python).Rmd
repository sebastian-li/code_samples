...
# some samples cannot be matched (resolved)
...
# # 1465
# 
# raw1$V1[which(!raw1$V1 %in% targets$targets)]
# #  [1] "205617020157_R01C01" "205617020157_R02C01" "205617020157_R03C01"
# #  [4] "205617020157_R04C01" "205617020157_R05C01" "205617020157_R06C01"
# #  [7] "205617020157_R07C01" "205617020157_R08C01" "204617080032_R01C01"
# # [10] "204617080032_R02C01" "204617080032_R03C01" "204617080032_R04C01"
# # [13] "204617080032_R05C01" "204617080032_R06C01" "204617080032_R07C01"
# # [16] "204617080032_R08C01" ""   
# 
# targets$targets[which(!targets$targets %in% raw1$V1)]
# #  [1] "205617080032_R01C01" "205617080032_R02C01" "205617080032_R03C01"
# #  [4] "205617080032_R04C01" "205617080032_R05C01" "205617080032_R06C01"
# #  [7] "205617080032_R07C01" "205617080032_R08C01" "205617080157_R01C01"
# # [10] "205617080157_R02C01" "205617080157_R03C01" "205617080157_R04C01"
# # [13] "205617080157_R05C01" "205617080157_R06C01" "205617080157_R07C01"
# # [16] "205617080157_R08C01"
...
#combined_post_qc = fread("/project/wiemels_494/sebastian/eyeDisease/codes/eye.proj.clinical.var.csv")
```

######################################################################## 

# on UCB HPC and do the sesame normalization

cd /ccls/home/sli/dependencies/r_self/ \*install R new version on
Berkeley HPC wget
<https://cran.r-project.org/src/base/R-4/R-4.1.2.tar.gz>

./configure\
--prefix=/ccls/home/sli/dependencies/r_self/R-4.1.2\
...
cd \~/sets/eyes /ccls/home/sli/dependencies/r_self/R-4.1.2/bin/./R

-   library location: /ccls/home/sli/dependencies/r_self/R-4.1.2/library

export TMPDIR=/ccls/home/sli/tempos export
EXPERIMENT_HUB_CACHE=/ccls/home/sli/.cache/R/ExperimentHub export
PATH="/ccls/home/sli/dependencies/r_self/R-4.1.2/bin:\$PATH"

/ccls/home/sli/dependencies/r_self/R-4.1.2/bin/./R setwd("\~/sets/eyes")

######################################################################## 

# on USC HPC and do the sesame normalization

```{r normalization of methylation sesame}
...
> > comparing the cell proportion differences between controls and
...
> > cell proportion differences between controls and different
> > phenotypes, controlling for gestational age
...
#setdiff(datClock_all_probe$probeId,rownames(methyl))
...
# compare different prototypes
# hyperopia_b,astigm2g_b,esotropia,exotropia,bi_decreased_vision, hyperopia_b2, hyperopia_bg3, astigm2g_b, astigm2g_b2,astigm_bg3
...
# 1: cg15808331 4.245565 0.9250213 4.589695 4.438947e-06   496      761 chr3
#         pos Relation_to_Island UCSC_RefGene_Name Probe_maf UCSC_RefGene_Group
# 1: 45142585            OpenSea             CDCP1        NA               Body
...
for(varName in c("hyperopia_b2","hyperopia_bg3","hyperopia_bg3.case.only")){
   ...
   #varName="hyperopia_bg3.case.only"
...
# [1] 0.84
#           cpg    Beta      SE        Z            P ncase ncontrol   chr
# 1: cg02286589 22.6601 5.15933 4.392062 1.122806e-05   109      761 chr16
#        pos Relation_to_Island UCSC_RefGene_Name Probe_maf UCSC_RefGene_Group
# 1: 1556286            S_Shore             TELO2        NA               Body
#    CpG_maf Regulatory_Feature_Group       fdr bf
# 1:      NA                          0.9999915  1
...
# 1: cg17122694 -3.721569 0.7088069 -5.25047 1.787799e-07 1257 chr1 222801447
#    Relation_to_Island UCSC_RefGene_Name Probe_maf UCSC_RefGene_Group CpG_maf
# 1:            OpenSea              MIA3        NA               Body      NA
#    Regulatory_Feature_Group       fdr        bf
# 1:                          0.1147149 0.1147149

# [1] "hyperopia_bg3.case.only"
# [1] 1.11
#           cpg      Beta       SE         Z           P ncase ncontrol  chr
# 1: cg21699194 -68.68683 14.14484 -4.855963 1.19803e-06   109      387 chr2
#         pos Relation_to_Island UCSC_RefGene_Name Probe_maf UCSC_RefGene_Group
# 1: 67791398            OpenSea                    0.015096                   
#    CpG_maf Regulatory_Feature_Group       fdr        bf
# 1:      NA                          0.7687207 0.7687207
