...
# 
# listp <- parApply(cl,predictors, 2, function(x, Y) {
#   corres = cor.test(x, y = Y, method = "pearson")
#   return(c(p=corres$p.value,corres$estimate,variance=var(x)))
#    }, Y = outcome)
# 
# listpDF = data.frame(listp) %>%
#   t() %>%
#   as.data.frame() %>%
#   rownames_to_column(var="var") %>%
#   arrange(p)
# write_rds(listpDF,"feature_selection_res.rds")
# stopCluster(cl)
